...
test('BetLab replaces the MLB custom builder with a priced-honest NRFI/YRFI zone and Results owns live tracking', async () => {
  ...
  assert.match(zone, /Offense no-run base/)
  assert.match(zone, /Starter scoreless 1st/)
  assert.match(zone, /Shrunk starter rate/)
  assert.match(zone, /Half scoreless base/)
