...
try {
  ...
  console.log(`[mlb-data] feature archive v${featureArchive.schemaVersion}: ${featureArchive.schemaV2Rows}/${featureArchive.population} settled hitter-games · clean pregame ${featureArchive.cleanPregameRows} · bat tracking ${featureArchive.groups.batTracking.available} · pitcher recent ${featureArchive.groups.pitcherRecent.available} · pitch types ${featureArchive.groups.pitchTypes.available}`)
} catch (error) {
