  ...
  return {
    ...
    closeBundle() {
      ...
      try {
        ...
        for (const f of ['daily.json', 'backtest-log.json', 'calibration.json', 'context.json', 'mlb-data-health.json', 'mlb-data-health-history.json', 'ai-hr-attribution.json', 'board-history.json', 'brief.json']) {
