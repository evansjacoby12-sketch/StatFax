  ...
  return {
    ...
    closeBundle() {
      ...
      try {
        ...
        for (const f of ['daily.json', 'browser-history.json', 'mlb-game-results.json', 'calibration.json', 'list-builder-evidence.json', 'context.json', 'mlb-data-health.json', 'mlb-data-health-history.json', 'ai-hr-attribution.json', 'zone-evaluation.json', 'board-history.json', 'brief.json']) {
