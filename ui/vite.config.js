  ...
  return {
    ...
    closeBundle() {
      ...
      try {
        ...
        for (const f of ['daily.json', 'browser-history.json', 'mlb-game-results.json', 'calibration.json', 'list-builder-evidence.json', 'mlb-data-health.json', 'zone-evaluation.json', 'board-history.json', 'brief.json']) {
