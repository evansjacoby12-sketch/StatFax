...
const GUIDE_SECTIONS = [
  ...
  ['Beaker', 'Bet Lab', 'Explore model combinations, build a custom slip, isolate one matchup, and review saved NFL tickets.'],
...
function NFLGuide() {
  return <div className="learn-embedded" role="tabpanel">
    ...
    <h3 className="section-title" style={{ marginTop: 18 }}><Icon name="GitBranch" size={14} />Reading Bet Lab</h3><p className="guide-p dim">Explore and Same Game rank NFL combinations from eligible player props. Custom Builder reviews the active slip. Saved owns ticket history and settlement. The displayed all-hit probability remains an independent product.</p>
  </div>
}
