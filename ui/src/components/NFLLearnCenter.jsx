...
function NFLGuide() {
  return <div className="learn-embedded" role="tabpanel">
    ...
    <h3 className="section-title" style={{ marginTop: 18 }}><Icon name="GitBranch" size={14} />Reading TD Bet Lab</h3><p className="guide-p dim">Scorer Core ranks Anytime TD anchors. Goal-Line Hammer requires QB/RB rushing work near the goal line. End-Zone Alpha requires WR/TE end-zone or red-zone targets. First Strike uses one First TD scorer per game. Double Tap uses only 2+ TD legs and carries extreme variance. Custom Builder ignores yardage and reception legs; all-hit remains an independent product.</p>
  </div>
}
