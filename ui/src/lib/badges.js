...
export const BADGES = [
  ...
  { key: 'rising', label: 'Rising', lucide: 'TrendingUp', color: 'var(--good)', tone: 'good', desc: 'Recent ~14-day barrel rate is meaningfully above the season rate with enough batted-ball evidence.' },
  { key: 'due', label: 'Due', lucide: 'TimerReset', color: 'var(--b-due)', tone: 'good', desc: 'Recent home-run results trail the underlying expected-power signal. Regression context—not a claim that a homer is imminent.' },
  { key: 'cold', label: 'Cold', lucide: 'Snowflake', color: 'var(--b-cold)', tone: 'bad', desc: 'Recent power or contact results are below the hitter’s baseline. A caution signal, not an automatic fade.' },
  ...
  { key: 'zoneEdge', label: 'Zone Edge', lucide: 'Grid3x3', color: 'var(--b-pitch)', tone: 'good', desc: 'Advisory location evidence: 2+ reliable strike-zone attacks with adjusted ISO ≥.200, pitcher exposure ≥1.10× the handedness baseline, and location rating ≥6.5/10.' },
  ...
  { key: 'blast', label: 'Blast', lucide: 'Bomb', color: 'var(--b-hot)', tone: 'good', desc: 'Elite recent blast rate from bat tracking: fast, squared-up contact on at least 25% of squared-up balls. Supporting evidence, not a guarantee.' },
